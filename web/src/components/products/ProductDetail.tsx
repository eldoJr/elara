        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-6">
          ...
          <div className="space-y-3">
            <img
              src={selectedImage}
              alt={product.title}
              className="w-full h-[400px] object-cover rounded-lg border border-gray-200 dark:border-gray-700"
            />
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="flex items-center gap-3 mb-3">
                <div className="flex items-center">
                  ...
                  <span className="text-base font-medium ml-1 text-gray-900 dark:text-white">{(product.rating || 0).toFixed(1)}</span>
                </div>
            ...
            <div>
              <h3 className="text-base font-semibold mb-2 text-gray-900 dark:text-white">Description</h3>
            ...
            <div className="flex items-center gap-3 pt-3">
              <div className="flex items-center border border-gray-300 dark:border-gray-600 rounded-lg">
                ...
                <span className="px-3 py-2 border-x border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white font-medium">{quantity}</span>
                <button
              ...
              <button
                ...
                className="flex-1 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white py-2.5 px-4 rounded-lg font-medium transition-colors"
              >
